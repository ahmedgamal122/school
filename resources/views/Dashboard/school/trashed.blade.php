...
@section('page-header')
        ...
        <div class="my-auto">
            <div class="d-flex">
				...
				@lang('lang.Trashrd_Schools') </span>
            </div>
        </div>
    </div>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										...
										<td>  <img style="width:100%;height: 90px" src=" {{url('/storage'.$trashed->logo_english)}}"></td>
										<td> <img style="width:100%;height: 90px" src=" {{url('/storage'.$trashed->logo_arabic)}}"></td>

		
		
												 <td>
												 <form method="POST"  action="{{route('school.restore',$trashed->id)}}" class="mr-2">
