            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="title d-flex justify-content-between">
                        <h4 class="mt-0 mb-0 header-title align-self-center text-capitalize"> @lang('lang.gov_edite') </h4>
                        <div class="buttons">
                    ...
                    <hr>
                    <form enctype="multipart/form-data" action="{{ route('governorates.update' , ['id' => $Governrate->id]) }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <input value="{{$Governrate->name_english}}" class="form-control" type="text" name="name_english">
                            @error('name_english')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{$Governrate->name_arabic}}" class="form-control" type="text" name="name_arabic">
                            @error('name_arabic')
                            <span class="text-danger mt-1">{{ $message }}</span>
                            @enderror
                        </div>
