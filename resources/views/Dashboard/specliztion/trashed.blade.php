...
@section('title')
@lang('lang.trashed_specializations')
@endsection
...
@section('page-header')
        ...
        <div class="my-auto">
            <div class="d-flex">
				...
				@lang('lang.trashed_specializations') </span>
            </div>
        </div>
    </div>
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<a href=" {{route('Specilization.index')}}">
								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										...
										<td>{{$trashed->name_arabic }}</td>
												 ...
												 <td>
												 <form method="POST"  action="{{route('Specilization.restore',$trashed->id)}}" class="mr-2">
