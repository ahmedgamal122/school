            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="title d-flex justify-content-between">
                        <h4 class="mt-0 mb-0 header-title align-self-center text-capitalize">@lang('lang.Adds_national')</h4>
                        <div class="buttons">
                    ...
                    <hr>
                    <form enctype="multipart/form-data" action="{{ route('nationalities.store') }}" method="POST">
                        @csrf
                        <div class="row">
