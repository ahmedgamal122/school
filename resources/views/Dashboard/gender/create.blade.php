            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="title d-flex justify-content-between">
                        <h4 class="mt-0 mb-0 header-title align-self-center text-capitalize">@lang('lang.Adds_gender')</h4>
                        <div class="buttons">
                            <a href="{{ route('gender.index') }}" class="mr-2">
                                <button class="btn btn-new"><i class="fa fa-list"></i>
                                @lang('lang.List_gender')</button>
                            </a>
                    ...
                    <hr>
                    <form enctype="multipart/form-data" action="{{ route('gender.store') }}" method="POST">
                        @csrf
                        <div class="row">
