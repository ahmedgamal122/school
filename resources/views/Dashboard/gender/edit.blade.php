        ...
        <div class="col-12 mx-auto">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <hr>
                    <form enctype="multipart/form-data" action="{{ route('gender.update' , ['id' => $Gender->id]) }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <input value="{{$Gender->name_english}}" class="form-control" type="text" name="name_english">
                            @error('name_english')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{$Gender->name_arabic}}" class="form-control" type="text" name="name_arabic">
                            @error('name_arabic')
                            <span class="text-danger mt-1">{{ $message }}</span>
                            @enderror
                        </div>
