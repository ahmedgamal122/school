...
@section('page-header')
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('lang.Teacher')</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                @lang('lang.Adds_teacher') </span>
            </div>
        </div>
    </div>
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="title d-flex justify-content-between">
                        <h4 class="mt-0 mb-0 header-title align-self-center text-capitalize">@lang('lang.Adds_teacher')</h4>
                        <div class="buttons">
                            <a href="{{ route('teachers.index') }}" class="mr-2">
                                <button class="btn btn-new"><i class="fa fa-list"></i>
                                @lang('lang.List_teacher')</button>
                            </a>
                    ...
                    <form enctype="multipart/form-data" action="{{ route('teachers.store') }}" method="POST">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="custom-select form-control" name="grades_id">
                                <option selected disabled value="">@lang('lang.Choose One')</option>
